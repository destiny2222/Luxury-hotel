...
<body x-data="{ mobileMenuOpen: false }">
    <header class="main-header">
        <nav class="container">
            <div class="logo">
                <a href="{{ route('home') }}">
                    <span class="logo-text">KINGS WOODS HOTEL</span>
                </a>
            </div>
        ...
        <div class="footer-top">
            <div class="container footer-grid">
                <div class="footer-info">
                    <span class="footer-logo">KINGS WOODS HOTEL AND SUITES</span>
                    <p>Experience the epitome of luxury and comfort at Kings woods Hotel and Suites. Your sanctuary of relaxation where the horizon meets the sea.</p>
                ...
                <div class="footer-contact">
                    ...
                    <p class="mb-4"><i class="fas fa-phone-alt text-primary mr-3"></i> <a href="tel:+2348081652353">+2348081652353</a></p>
                    <p class="mb-4"><i class="fab fa-whatsapp text-primary mr-3"></i> <a href="https://wa.me/+2348072638793">+2348072638793</a></p>
                    <p class="mb-4"><i class="fas fa-envelope text-primary mr-3"></i> <a href="mailto:Kingswoodshotelandsuites@gmail.com">Kingswoodshotelandsuites@gmail.com</a></p>
                </div>
            </div>
        </div>
        <div class="footer-bottom">
            <div class="container">
                <p>&copy; {{ date('Y') }} Kings woods Hotel and Suites. Crafted with Dexnovate.</p>
            </div>
        </div>
    </footer>
